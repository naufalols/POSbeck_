	...
	<div class="row mt-1 ">
		<div class="col-sm m-1  border-0">
			<div class="container-fluid">
				<h5 class="mb-4">Admin <small>Pelanggan</small></h5>
				<div class="">
					<div class="">
						<table id="table-pelanggan" class="table table-sm table-rounded table-pembukuan  table-light table-striped table-bordered display  table-hover nowrap shadow-sm" style="width:100%">
							<thead>
								<tr>
									<td>Id</td>
									<td>Nama</td>
