						...
						<div class="row">
							<div class="col-sm-4 col-kiri">
								...
								//$row['kode_nota'];
										...
										?>
										<li class="nav-item">
											<a class="nav-link btn <?php if($i == $count){echo ' active';} ?>" role="button" aria-expanded="false" aria-controls="#" onclick="filterKeranjang('<?= $row['kode_nota']; ?>')">
								...
								<ul class="nav nav-tabs mt-1" id="filterMenu">
									<li class="nav-item list-group form-inline">
										<div class="list-group form-inline">
											<a class="nav-link btn active" onclick="filterSelection('all')" role="button">All</a>
										</div>
									</li>
									<?php foreach ($data['dbkategori'] as $kategori) { ?>
									<li class="nav-item list-group form-inline">
										<div class="list-group form-inline">
											<a class="nav-link btn" onclick="filterSelection('<?= $kategori['kategori_sub'] ?>')" role="button"><?= $kategori['kategori_sub'] ?></a>
										</div>
									</li>
									<?php } ?>
									...
									<div class="">
										<div class="">
											...
											foreach ($data['dbnota'] as $row) {
												...
												$diskon = $row['diskon'];
												?>
												<div class="collapse <?= $kodenota; ?> <?php if($q == $count){echo 'show';} ?>" id="collapseKeranjang<?= $kodenota; ?>" data-parent="#accordionKeranjang">
													<div class="card-body">
														<div class="container-fluid">
															<div class="row">
