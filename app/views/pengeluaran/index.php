	...
	<div class="row mt-1 ">
		<div class="col-sm m-1  border-0">
			<div class="container-fluid">
				...
				<div class="">
					<div class="">
						<table id="table-pengeluaran" class="table table-rounded table-pengeluaran  table-light table-striped table-bordered display  table-hover nowrap shadow-sm" style="width:100%">
							<thead class="thead-pengeluaran">
								<tr>
									<th>Id</th>
									<th>Tanggal</th>
									<th>Item</th>
					...
					<div class="">
						...
						if ($tanggal_akhir == 0) { ?>
							<div class="form-inline justify-content-center">
								<button class="btn btn-outline-success" data-toggle="modal" data-target="#tambahpengeluaran">Tambahkan</button>
							</div>
						<?php } else { ?>
							<div class="form-inline justify-content-center">
...
<div class="modal fade" id="tambahpengeluaran" tabindex="-1" role="dialog" aria-labelledby="tambahpengeluaran" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<form id="modalpengeluaran" action="<?= BASEURL; ?>/pengeluaran/tambahpengeluaran" method="post">
				...
				<div class="modal-body">
					<?php foreach ($data['dbkategoripengeluaran'] as $row) : ?>
